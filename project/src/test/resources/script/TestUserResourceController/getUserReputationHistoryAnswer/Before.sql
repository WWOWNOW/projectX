...
INSERT INTO answer(id, html_body, is_deleted, is_deleted_by_moderator, is_helpful, update_date, question_id, user_id)
values (100, 'HTML', true, false, false, now(), 100, 100);

insert into reputation(id, count, persist_date, type, answer_id, author_id, question_id, sender_id)
values (100, 5, '2022-11-04T00:00:00', 3, 100, 100, 100, 100),
       (101, 5, '2022-11-03T00:00:00', 3, 100, 100, 100, 100),
       (102, -15, '2022-11-02T00:00:00', 3, 100, 100, 100, 100)