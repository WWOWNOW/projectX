...
INSERT INTO message (id, last_redaction_date, message, chat_id, user_sender_id,persist_date)
VALUES (101,now(),'message100',100,100,'2022-10-27');

INSERT INTO message (id, last_redaction_date, message, chat_id, user_sender_id,persist_date)
VALUES (103,now(),'message100',100,100,'2022-10-27');
INSERT INTO message (id, last_redaction_date, message, chat_id, user_sender_id,persist_date)
VALUES (104,now(),'message100',100,100,'2022-10-27');
INSERT INTO message (id, last_redaction_date, message, chat_id, user_sender_id,persist_date)
VALUES (105,now(),'message100',100,100,'2022-10-27');

INSERT INTO message_star (id, persist_date, message_id, user_id)
VALUES (103, now(), 100, 100);
INSERT INTO message_star (id, persist_date, message_id, user_id)
VALUES (104, now(), 100, 100);
INSERT INTO message_star (id, persist_date, message_id, user_id)
VALUES (105, now(), 100, 100);
