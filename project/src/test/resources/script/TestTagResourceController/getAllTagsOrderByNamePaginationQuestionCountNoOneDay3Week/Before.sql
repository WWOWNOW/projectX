...
values (100, 'Question delete 0', now(), false, date(now() - interval '2' day), 'Title 0',100),
       (101, 'Question delete 0', now(), false, date(now() - interval '3' day), 'Title 0',100),
       (102, 'Question delete 0', now(), false, date(now() - interval '4' day), 'Title 0',100);
